                        ...
                        <div class="flex items-center justify-between gap-3 text-sm">
                            <label for="remember_me" class="inline-flex items-center gap-2 text-slate-600">
                                <input id="remember_me" type="checkbox"
                                    class="h-4 w-4 rounded border-slate-300 text-blue-600 shadow-sm focus:ring-blue-400"
                                    name="remember">
                                <span>{{ __('Ingat saya') }}</span>
                            </label>

                            @if (Route::has('password.request'))
                                <a class="font-medium text-blue-600 transition hover:text-blue-700 hover:underline"
                ...
                <div class="relative z-10 flex h-full flex-col justify-between p-10 text-white lg:p-12">
                    <div>
                        ...
                        <h2 class="max-w-sm text-4xl font-black leading-tight tracking-tight">
                            Belanja lebih cepat, lebih aman, dan lebih menyenangkan.
                        </h2>
                    </div>

                    <div class="rounded-3xl border border-white/15 bg-white/10 p-5 backdrop-blur-md">
                        <p class="text-xs uppercase tracking-[0.2em] text-blue-100">Fitur utama</p>
                        <div class="mt-4 space-y-4 text-sm text-blue-50">
                            <div class="flex items-center gap-3">
                                ...
                                <span>Produk berkualitas dengan checkout mudah</span>
                            </div>
                            <div class="flex items-center gap-3">
                                <span
                                    class="flex h-8 w-8 items-center justify-center rounded-full bg-white/15 text-lg">✓</span>
                                <span>Pembayaran lebih aman dan transparan</span>
                            </div>
                            <div class="flex items-center gap-3">
                                <span
                                    class="flex h-8 w-8 items-center justify-center rounded-full bg-white/15 text-lg">✓</span>
                                <span>Kelola pesanan dan toko dengan mudah</span>
                            </div>
                        </div>
                    </div>
                </div>
