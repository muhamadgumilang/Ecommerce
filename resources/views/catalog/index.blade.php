        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500 mt-1">Temukan berbagai koleksi produk berkualitas terbaik dengan
                        harga terjangkau.</p>
                </div>
                <div
                    class="text-xs font-semibold text-slate-600 bg-slate-100 px-3.5 py-2 rounded-xl border border-slate-200">
                            ...
                            <div class="p-5 flex-1 flex flex-col justify-between space-y-4">
                                <div>
                                    ...
                                    <div class="flex items-center gap-1.5 text-xs text-slate-500 mt-1">
                                        <span>🏪</span>
                                        <span class="font-medium text-slate-600 truncate">{{ $item->seller?->name ?? 'Zenthercraft Store' }}</span>
                                    </div>
