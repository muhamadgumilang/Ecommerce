...
<body
    class="font-sans antialiased bg-slate-50 text-slate-800 min-h-screen flex flex-col justify-between selection:bg-blue-600 selection:text-white">
    ...
    <div class="flex flex-col min-h-screen justify-between">
        ...
        <main class="flex-1 py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
            ...
            <div
                class="bg-white border border-slate-200/80 p-8 sm:p-12 rounded-3xl shadow-xl shadow-slate-200/50 mb-14 text-center">
                <div class="max-w-2xl mx-auto">
                    <!-- Badge Kecil -->
                    <div
                        class="inline-flex items-center space-x-2 bg-blue-50 text-blue-600 text-xs font-bold px-3.5 py-1.5 rounded-full uppercase tracking-wider mb-5 border border-blue-100">
                    ...
                    <p class="text-sm sm:text-base text-slate-600 mb-8 leading-relaxed">
                        Sistem manajemen berbasis web yang cepat, responsif, dan nyaman digunakan untuk kebutuhan
                        e-commerce Anda.
                    </p>
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-3">
                        <a href="{{ route('catalog.index') }}"
                            class="px-6 py-3 bg-white hover:bg-slate-50 text-blue-600 border border-blue-200 font-bold rounded-xl transition text-sm shadow-sm">
            ...
            <div>
                <div class="flex justify-between items-center mb-6 border-b border-slate-200 pb-4">
                    <div>
                        ...
                        <p class="text-xs text-slate-500 mt-0.5">Jelajahi produk berkualitas tinggi yang tersedia untuk
                            Anda.</p>
                    </div>
                    <a href="{{ route('catalog.index') }}"
                ...
                @if (isset($products) && $products->count() > 0)
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        @foreach ($products as $product)
                            <div
                                class="bg-white rounded-2xl shadow-md border border-slate-200/80 overflow-hidden hover:border-blue-300 hover:shadow-lg transition flex flex-col justify-between group">
                                <div>
                                    <!-- Gambar Produk dengan Ukuran Terkunci -->
                                    <div style="height: 180px;"
                                        class="bg-slate-100 flex items-center justify-center text-slate-400 font-medium overflow-hidden relative">
                                        ...
                                        @if (isset($product->category))
                                            <span
                                                class="absolute top-2.5 left-2.5 bg-white/90 backdrop-blur-sm text-slate-700 text-[10px] font-bold px-2.5 py-1 rounded-md border border-slate-200 shadow-sm">
                                    ...
                                    <div class="p-4">
                                        <h3
                                            class="font-bold text-slate-900 text-sm mb-1 truncate group-hover:text-blue-600 transition">
                                ...
                                <div class="px-4 pb-4 flex items-center justify-between mt-auto">
                                    ...
                                    <a href="{{ route('products.show', $product) }}"
                                        class="px-3 py-1.5 bg-blue-50 hover:bg-blue-600 text-blue-600 hover:text-white transition rounded-lg text-base border border-blue-100"
                ...
                @else
                    ...
                    <div class="text-center py-12 bg-white rounded-2xl border border-dashed border-slate-300 shadow-sm">
                        <p class="text-slate-500 text-xs font-medium">Belum ada produk yang tersedia saat ini. Silakan
                            tambahkan produk melalui panel admin.</p>
                    </div>
                @endif
            </div>
